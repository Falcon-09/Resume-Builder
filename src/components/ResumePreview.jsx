        ...
        >
          <div ref={printElem}>
            ...
            >
              ...
              <HStack spacing={1}>
                <MdLocalPhone />{" "}
                <Text>{about.phone ? about.phone : "+919191919191"}</Text>
              </HStack>
              <HStack spacing={1}>
                <MdLocationPin />{" "}
                <Text>{about.address ? about.address : "Noida, UP"}</Text>
              </HStack>
              <HStack spacing={1}>
                <RiLinkedinBoxFill />{" "}
                  ...
                  {educationList.map((education) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <Text fontSize={"sm"}>
                          {school ? school : "Massachusetts Institute of Technology"}
                        </Text>
                        <HStack
                          fontSize={"xs"}
                          fontStyle={"italic"}
                    ...
                    return (
                      ...
                      >
                        ...
                        <Text fontSize={"sm"} as="p">
                          {desc
                            ? desc
                            : "Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, quis officia molestias cum atque temporibus assumenda modi quam laborum enim repellendus, voluptatibus eaque, debitis eum? Quis asperiores laboriosam quisquam rerum."}
                        </Text>
                      </VStack>
                    );
                  })}
